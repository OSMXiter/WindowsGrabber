...
* __Función:__ [100 %CPU](https://github.com/OSMXiter/CPU_Stress) <= un conjunto de calculos básicos matemáticos y bucles exponenciales.

<!-- Creador  -->
---
## By OSMXiter
- [Github](https://github.com/OSMXiter)
- [Facebook](https://www.facebook.com/OSMXiter)
- [Linkedin](https://www.linkedin.com/in/OSMXiter)
- [Telegram](https://t.me/OSMXiter)
